...
export const STRINGS: Record<Lang, Strings> = {
  de: {
    ...
    examples: [
      ...
      'Welche Züge fahren in der nächsten Stunde ab Hamburg Hbf?',
      'Ist mein ICE von Frankfurt nach Berlin pünktlich?',
      'Verbindung von Stuttgart nach Zürich morgen um 9 Uhr',
      'Hat der Zug von Dortmund nach Düsseldorf ein Bordrestaurant?',
      'Kann ich mein Fahrrad im RE von Köln nach Aachen mitnehmen?',
      'Was kostet die günstigste Verbindung von Leipzig nach Berlin?',
      'Gibt es am Nürnberg Hbf öffentliche Toiletten und Schließfächer?',
      'Funktioniert die Rolltreppe am Frankfurt Hbf?',
      'Welche Bahnhöfe sind in der Nähe vom Kölner Dom?',
      'Ich stehe in Essen und will nach Bremen — wann muss ich los?',
      'Auf welchem Gleis fährt der nächste Zug nach Hannover ab München?',
      'Wann kommt der ICE aus Hamburg in Berlin an?',
      'Gibt es WLAN im ICE von Berlin nach Köln?',
      'Schaffe ich meinen Anschluss in Mannheim, wenn mein Zug 15 Minuten Verspätung hat?',
      'Nächste Abfahrten ab Iserlohn Richtung Dortmund',
      'Ist der Bahnhof Münster stufenfrei zugänglich?',
      'Beste Verbindung von Freiburg nach Hamburg mit möglichst wenig Umstiegen',
    ],
  ...
  en: {
    ...
    examples: [
      ...
      'Which trains leave Hamburg Hbf in the next hour?',
      'Is my ICE from Frankfurt to Berlin on time?',
      'Connection from Stuttgart to Zurich tomorrow at 9 am',
      'Does the train from Dortmund to Düsseldorf have a bord restaurant?',
      'Can I take my bike on the RE from Köln to Aachen?',
      'What’s the cheapest fare from Leipzig to Berlin?',
      'Are there public toilets and lockers at Nürnberg Hbf?',
      'Is the escalator at Frankfurt Hbf working?',
      'Which stations are near Cologne Cathedral?',
      'I’m in Essen and want to go to Bremen — when should I leave?',
      'Which platform does the next train to Hannover leave from in Munich?',
      'When does the ICE from Hamburg arrive in Berlin?',
      'Is there Wi-Fi on the ICE from Berlin to Köln?',
      'Will I make my connection in Mannheim if my train is 15 minutes late?',
      'Next departures from Iserlohn towards Dortmund',
      'Is Münster station step-free / accessible?',
      'Best connection from Freiburg to Hamburg with as few transfers as possible',
    ],
  ...
  tr: {
    ...
    examples: [
      ...
      'Önümüzdeki bir saatte Hamburg Hbf’den hangi trenler kalkıyor?',
      'Frankfurt’tan Berlin’e ICE’im zamanında mı?',
      'Yarın saat 9’da Stuttgart’tan Zürih’e bağlantı',
      'Dortmund’dan Düsseldorf’a trende yemekli vagon var mı?',
      'Köln’den Aachen’a RE’de bisikletimi götürebilir miyim?',
      'Leipzig’den Berlin’e en ucuz bağlantı ne kadar?',
      'Nürnberg Hbf’de umumi tuvalet ve emanet dolabı var mı?',
      'Köln Katedrali yakınında hangi istasyonlar var?',
      'Berlin’den Köln’e ICE’de WiFi var mı?',
      'Iserlohn’dan Dortmund yönüne sonraki kalkışlar',
    ],
  ...
  fr: {
    ...
    examples: [
      ...
      'Quels trains partent de Hamburg Hbf dans la prochaine heure ?',
      'Mon ICE de Francfort à Berlin est-il à l’heure ?',
      'Correspondance de Stuttgart à Zurich demain à 9 h',
      'Le train de Dortmund à Düsseldorf a-t-il une voiture-restaurant ?',
      'Puis-je emmener mon vélo dans le RE de Köln à Aachen ?',
      'Quel est le tarif le moins cher de Leipzig à Berlin ?',
      'Y a-t-il des toilettes publiques et des consignes à Nürnberg Hbf ?',
      'Quelles gares sont proches de la cathédrale de Cologne ?',
      'Y a-t-il du Wi-Fi dans l’ICE de Berlin à Köln ?',
      'Prochains départs d’Iserlohn en direction de Dortmund',
    ],
  ...
  es: {
    ...
    examples: [
      ...
      '¿Qué trenes salen de Hamburg Hbf en la próxima hora?',
      '¿Mi ICE de Fráncfort a Berlín va a tiempo?',
      'Conexión de Stuttgart a Zúrich mañana a las 9',
      '¿El tren de Dortmund a Düsseldorf tiene vagón restaurante?',
      '¿Puedo llevar mi bici en el RE de Köln a Aachen?',
      '¿Cuál es la tarifa más barata de Leipzig a Berlín?',
      '¿Hay aseos públicos y consignas en Nürnberg Hbf?',
      '¿Qué estaciones hay cerca de la catedral de Colonia?',
      '¿Hay wifi en el ICE de Berlín a Köln?',
      'Próximas salidas desde Iserlohn dirección Dortmund',
    ],
  ...
  it: {
    ...
    examples: [
      ...
      'Quali treni partono da Hamburg Hbf nella prossima ora?',
      'Il mio ICE da Francoforte a Berlino è in orario?',
      'Coincidenza da Stoccarda a Zurigo domani alle 9',
      'Il treno da Dortmund a Düsseldorf ha il vagone ristorante?',
      'Posso portare la bici sul RE da Köln ad Aachen?',
      'Qual è la tariffa più economica da Lipsia a Berlino?',
      'Ci sono bagni pubblici e armadietti a Nürnberg Hbf?',
      'Quali stazioni ci sono vicino al Duomo di Colonia?',
      'C’è il Wi-Fi sull’ICE da Berlino a Köln?',
      'Prossime partenze da Iserlohn in direzione Dortmund',
    ],
